...
public class Elevator {
    ...
    private int floor = 0;
    private int number;
    private State_elev state = State_elev.STOPPED;
    ...
    public Elevator(Controller c, int num) {
        controller = c;
        number = num;
    }
    ...
    public final State_elev getState() {
        return this.state;
    }
